...
class SaveTripDetails(APIView):
    ...
    def extract_lat_long(self, data):
        ...
        for day in data.values():
            for place in day:
                lat_long_values.append(place["lat_long"])
    ...
    def fetch_nearby_restaurants(self, lat_long_values):
        ...
        for index, lat_long in enumerate(lat_long_values, start=1):
            lat, long = lat_long.split(',')
            url = f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={lat},{long}&radius={radius}&type=restaurant&maxprice={max_price}&key={api_key}"
            ...
            if response.status_code == 200:
                ...
                results[index] = {"error": response.status_code}
    ...
    def post(self, request):
        try:
            ...
            model = genai.GenerativeModel(
                ...
                system_instruction='Generate an itinerary based on the information received from the user. Each day should include maximum 2 activites and those activities should not include any restaurants. It should only be landmarks and historical places based on user\'s preferences.\n\n### INFORMATION ###\nThe user will provide you with the input in the below format:\n- stay_details\n- number_of_days\n- budget\n- additional_preferences\nThe output should be a JSON structure as shown below:\n\nTOE: It indicates the approx time for exploring that particular activity.\n<OUTPUT FORMAT>\n{  "1":[{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"},{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"}],\n  "2":[{"place_name":"val1","description":"val2","TOE":"val3", "lat_long":"val1,val2"},{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2" }],\n  "3":[{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"},{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"}, {"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"}],\n  "4":[{"place_name":"val1","description":"val2","TOE":"val3","lat_long":"val1,val2"}],\n}\n<OUTPUT FORMAT/>',
            )
